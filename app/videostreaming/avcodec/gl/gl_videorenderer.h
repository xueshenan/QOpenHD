...
public:
  ...
  int get_current_video_width() const {return _current_video_width;}
  int get_current_video_height() const {return _current_video_height;}
public:
...
private:
  //
  int _current_video_width = 0;
  int _current_video_height = 0;
 ...
 public:
  ...
  NV12FrameTexture nv12_frametexture{};
